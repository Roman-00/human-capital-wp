<?php
/** Добавляем возможность устанавливать свой логотип */
add_theme_support('custom-logo');

/** Добавляем возможность устанавливать превью для изображений */
add_theme_support('post-thumbnails');

/** Активируем меню на сайте */
add_theme_support('menus');

/** Подключаем стили и скрипты на сайте */
add_action('wp_enqueue_scripts', 'human_scripts');

function human_scripts() {
    wp_enqueue_style('swiper-style', get_template_directory_uri() . '/assets/css/swiper-bundle.min.css');
    wp_enqueue_style('main-style', get_stylesheet_uri());
    wp_enqueue_script('swiper-script', get_template_directory_uri() . '/assets/js/swiper-bundle.min.js', array(), null, true);
    wp_enqueue_script('main-script', get_template_directory_uri() . '/assets/js/main.js', array(), null, true);
}



/** Добавляем новый фильтр, в админке ID */
